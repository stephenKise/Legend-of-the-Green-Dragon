...
function myDefine(string $name, $value): bool
{
    global $defines;
    define($name, $value);
    $defines[$name] = $value;
...
myDefine('CHAR_DELETE_PERMADEATH', 3); //reserved for the future -- I don't have any plans this way currently,  but it seemed appropriate to have it here. -DragonPrime Development Team?
