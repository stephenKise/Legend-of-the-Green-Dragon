...
switch ($op) {
    case "search":
        include_once "lib/graveyard/case_battle_search.php";
        break;
    case "run":
        if (e_rand(0, 2) == 1) {
...
if ($battle) {
    ...
    $session['user']['defense'] = 10 + round(($session['user']['level'] - 1) * 1.5);
...
switch ($op) {
    ...
    case "fight":
        break;
    case "enter":
        include_once "lib/graveyard/case_enter.php";
        break;
    case "restore":
        include_once "lib/graveyard/case_restore.php";
        break;
    case "resurrection":
        include_once "lib/graveyard/case_resurrection.php";
        break;
    case "question":
        include_once "lib/graveyard/case_question.php";
        break;
    case "haunt":
        include_once "lib/graveyard/case_haunt.php";
        break;
    case "haunt2":
        include_once "lib/graveyard/case_haunt2.php";
        break;
    case "haunt3":
        include_once "lib/graveyard/case_haunt3.php";
        break;
    default:
        include_once "lib/graveyard/case_default.php";
        break;
}
